...
import { MockV3Aggregator, FundMe } from '../../typechain-types'
  ...
  : describe('FundMe', async function () {
      ...
      describe('withdraw', async function () {
        ...
        it('Should withdraw ETH from a single funder', async function () {
          ...
          console.log({
            actual: startingFundMeBalance
              .add(startingDeployerBalance)
              .toString(),
            endingDeployerBalance: endingDeployerBalance.toString(),
            gasCost: gasCost.toString(),
            expected: endingDeployerBalance.add(gasCost).toString(),
          })
        ...
        it('Should allow to withdraw with multiple funders', async function () {
          // Arrange
